...
public class Test {
	public static void main(String[] args) {
		...
		TestRunner.runTest(()->{
			...
			Square sq = new Square(1, "black");
			Shape[] s = {c0, c1, r, sq};
			Shapes ss = new Shapes(s);
			System.out.printf("Ans: %.2f\n", ss.getArea());
			System.out.println("Expected: 15.28");
			if (ss.getArea() == Math.PI * 2 + 9)
				System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
		...
		TestRunner.runTest(()->{
			...
			System.out.println("[Circle(#),Circle(#),Rectangle(Red),Square(black)]");
			if (ss.toString().equals("[Circle(#),Circle(#),Rectangle(Red),Square(black)]"))
				System.out.println("Accept");
			else System.out.println("Wrong Answer");
		},1000);
