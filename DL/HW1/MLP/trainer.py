...
class Trainer:
    def __init__(self, args):
        ...
        self.train_loss_alltime = {}
        self.vali_loss_alltime = {}
        self.test_loss_alltime = {}
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y) in enumerate(train_loader):
                ...
                self.train_loss_alltime[(epoch, i)] = loss
            ...
            self.vali_loss_alltime[epoch] = vali_loss
            self.test_loss_alltime[epoch] = test_loss
        ...
        with open('./cache/train_loss_alltime.pkl', 'wb') as f:
            pickle.dump(self.train_loss_alltime, f)
        with open('./cache/vali_loss_alltime.pkl', 'wb') as f:
            pickle.dump(self.vali_loss_alltime, f)
        with open('./cache/test_loss_alltime.pkl', 'wb') as f:
            pickle.dump(self.test_loss_alltime, f)
