...
import pickle
with open('./logs/gcn/loss_hist.pkl', 'wb') as f:
    pickle.dump(loss_hist, f)
with open('./logs/gcn/acc_train_hist.pkl', 'wb') as f:
    pickle.dump(acc_train_hist, f)
with open('./logs/gcn/acc_valid_hist.pkl', 'wb') as f:
    pickle.dump(acc_valid_hist, f)
with open('./logs/gcn/acc_test_hist.pkl', 'wb') as f:
